        ...
        <div data-aos="fade-up" className="flex flex-col h-screen w-full items-center justify-center md:flex-row gap-10 p-5" id="secao1">
            ...
            <div className="flex w-auto flex-col items-start justify-center gap-4">
                ...
                <div data-aos="zoom-in" className="flex w-full justify-start">
                    <div className="drop-shadow-md flex p-5 flex-col items-start justify-center bg-gradient-to-bl from-violet-950 from-70% w-3/5 h-36 hover:bg-gradient-to-bl hover:from-violet-900 hover:from-70% hover::after:transition-colors duration-100 lg:w-96 ">
                ...
                <div data-aos="zoom-in" className="flex w-full justify-end">
                    <div className="drop-shadow-md flex p-5 flex-col items-start justify-center bg-gradient-to-bl from-violet-950 from-70% w-3/5 h-36 hover:bg-gradient-to-bl hover:from-violet-900 hover:from-70% hover::after:transition-colors duration-100 lg:w-96">
                        ...
                        <p className="text-sm pl-5">Função: <scan className="text-cyan-500">Full Stack Designer</scan></p>
                        <p className="text-sm">{colchetes2}</p>
                    </div>
                </div>
            </div>
